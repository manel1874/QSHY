...
// NOTA:: OS encodings de A C G T estão ao contrario! por isso... o 10 na realidade é o 01. É preciso mudar
...
void mpc_main(Array_Seq INPUT_A, Array_Seq INPUT_B)
{
	...
	int OUTPUT_distance;
	//OUTPUT_distance = (32 - 2*n1_dist-n2_dist)*(32 - 2*n1_dist-n2_dist)*(32-2*n2_dist);
	OUTPUT_distance = n2_dist;
